      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col gap-6 w-full md:w-[414px] shrink-0">
          ...
          <div className="flex items-center justify-between w-full leading-normal">
            <p
              className="font-medium text-[#0f142e] dark:text-foreground text-[18px] tracking-[0.9px]"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              {aircraftName}
            </p>
            <p
              className="font-normal text-[#959595] dark:text-muted-foreground text-[13px] tracking-[0.65px]"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              {aircraftCategory}
            </p>
          ...
          <div className="flex gap-[48px] items-center py-3 w-full">
            ...
            <div className="flex flex-col leading-normal">
              <p
                className="font-semibold text-[#0f142e] dark:text-foreground text-[48px] tracking-[2.4px] uppercase"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {fromCode}
              </p>
              <p
                className="font-semibold text-[#0f142e] dark:text-foreground text-[12px] tracking-[0.6px] uppercase"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {fromCity}
              </p>
            ...
            <div className="flex flex-1 gap-[12px] items-center justify-center min-w-0 min-h-0">
              <div className="h-0 w-[20px] relative shrink-0">
                <div className="absolute inset-0 top-[-1px]">
                  <div className="h-[1px] w-full bg-[#959595] dark:bg-muted-foreground"></div>
                </div>
              </div>
              <Plane className="w-6 h-6 text-[#0f142e] dark:text-foreground rotate-90 shrink-0" strokeWidth={2} />
              <div className="h-0 w-[20px] relative shrink-0">
                <div className="absolute inset-0 top-[-1px]">
                  <div className="h-[1px] w-full bg-[#959595] dark:bg-muted-foreground"></div>
                </div>
          ...
          <div className="flex items-center justify-between h-[60px] relative w-full">
            ...
            <div className="flex flex-col items-start justify-center leading-normal text-[#0f142e] dark:text-foreground">
              <p
                className="font-bold text-[18px] tracking-[0.9px] uppercase"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {departureTime}
              </p>
              <p
                className="font-medium text-[12px] tracking-[0.6px]"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {departureDate}
              </p>
            ...
            {/* Duration - Centered */}
            <div className="flex flex-col items-center justify-center absolute left-1/2 -translate-x-1/2 top-[7px] leading-normal text-[#0f142e] dark:text-foreground">
              <p
                className="font-medium text-[15px] tracking-[0.75px]"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {duration}
              </p>
