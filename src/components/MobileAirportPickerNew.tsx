...
export function MobileAirportPickerNew({
  ...
  // Load nearby airports and recent searches when dialog opens
  React.useEffect(() => {
    if (open && !searchQuery) {
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="p-0" showCloseButton={false}>
          {/* Header */}
          <DialogHeader className="border-b px-4 py-4 flex-row items-center justify-between space-y-0 shrink-0">
            ...
            <Command shouldFilter={false} className="h-auto bg-transparent">
              <CommandList className="max-h-none">
                ...
                {!searchQuery && showNearby && (
                  <CommandGroup heading="Nearby Locations" className="pb-4">
                    {loadingNearby ? (
                ...
                {!searchQuery && recentSearches.length > 0 && (
                  <CommandGroup heading="Recent Searches" className="pb-4">
                ...
                {searchQuery && searchResults.length > 0 && (
                  <CommandGroup heading="Search Results" className="pb-4">
