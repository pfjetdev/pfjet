  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-[120] flex flex-col shadow-lg duration-200",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          isMobile ? [
            // Mobile: Full screen from bottom (drawer style)
      ...
      >
        {isMobile && (
          <div className="mx-auto mt-4 h-1 w-[60px] shrink-0 rounded-full bg-muted" />
        )}
